...
[Shop context PR #22](https://github.com/crz0614/marketplace-payment-loop/pull/22) identifies each run by its existing shop and channel without adding a table or dependency. [CSV export PR #27](https://github.com/crz0614/marketplace-payment-loop/pull/27) safely exports the current owner-scoped view. [Status normalization PR #28](https://github.com/crz0614/marketplace-payment-loop/pull/28) preserves the original platform value while PostgreSQL derives pending-payment, processing, shipped, completed, cancelled, refunded or other. [All-row summary PR #29](https://github.com/crz0614/marketplace-payment-loop/pull/29) adds a restricted owner-scoped aggregate beyond the 200-row ledger. [Inventory PR #30](https://github.com/crz0614/marketplace-payment-loop/pull/30) adds an owner-scoped latest-inventory table, atomic shop/SKU upserts, source evidence and low-stock filtering. [Cross-shop inventory PR #31](https://github.com/crz0614/marketplace-payment-loop/pull/31) adds an exact-SKU aggregate for total availability, combined reorder points and affected low-stock shops. [Replenishment export PR #32](https://github.com/crz0614/marketplace-payment-loop/pull/32) exports the selected shop's latest 200 low-stock rows as a formula-safe UTF-8 purchasing handoff without inventing order quantities. [Reconciliation PR #33](https://github.com/crz0614/marketplace-payment-loop/pull/33) finds exact shop/SKU order lines with no inventory record, without fuzzy matching or cross-account access. [Reconciliation actions PR #34](https://github.com/crz0614/marketplace-payment-loop/pull/34) persists owner-scoped investigating/ignored state and a bounded note, while an exact inventory match removes the exception automatically. CI passed all 38 tests. A live authenticated flow persisted `MISSING-ACTION` as investigating with the note `Check September export`, rejected a cross-owner update with 404, then returned no exception after importing an exact inventory match; cleanup confirmed zero remaining test users, sessions, shops, orders, inventory and actions. Direct channel APIs remain disabled until merchant
